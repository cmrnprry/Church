...
//literally copypasted the fade anim but making it go backwards
namespace Febucci.UI.Effects
{
    [UnityEngine.Scripting.Preserve]
    [CreateAssetMenu(fileName = "Fade-In Behavior", menuName = "Text Animator/Animations/Behaviors/Fade-In")]
    [EffectInfo("fadein", EffectCategory.Behaviors)]
    public sealed class FadeInBehavior : BehaviorScriptableBase
    {
        Color32 temp;
