	...
	public class WarpManager
	{
		...
		public bool OnSceneGUI(SerializedObject serializedObject, Transform imageWarpTransform, Vector2 dimensions, Vector2? pivotPoint)
		{
			...
			if (m_memberProperty.boolValue)
			{
				...
				var fmh_851_64_638849965731863015 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
#else
...
#if UNITY_5_5_OR_NEWER
				var fmh_867_64_638849965731887968 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
#else
				m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
#endif
...
#if UNITY_5_5_OR_NEWER
				var fmh_884_64_638849965731890653 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
#else
				m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
#endif
				...
				m_handlePos = m_topLeftCornerPosition + (imageWarpTransform.rotation * Vector3.Scale( m_memberProperty.vector3Value, m_currentScale ));
#if UNITY_5_5_OR_NEWER
				var fmh_899_64_638849965731893033 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
#else
				m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
#endif
				Handles.DrawLine (m_topLeftCornerPosition, m_newHandlePosition);
				...
				m_handlePos = m_topRightCornerPosition + (imageWarpTransform.rotation * Vector3.Scale( m_memberProperty.vector3Value, m_currentScale ));
#if UNITY_5_5_OR_NEWER
				var fmh_916_64_638849965731895395 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
#else
				m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
#endif
				Handles.DrawLine (m_topRightCornerPosition, m_newHandlePosition);
...
#if UNITY_5_5_OR_NEWER
				var fmh_931_64_638849965731897758 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
#else
				m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
#endif
				...
				m_handlePos = m_bottomRightCornerPosition + (imageWarpTransform.rotation * Vector3.Scale( m_memberProperty.vector3Value, m_currentScale ));
#if UNITY_5_5_OR_NEWER
				var fmh_948_64_638849965731900078 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
#else
				m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
#endif
				Handles.DrawLine (m_bottomRightCornerPosition, m_newHandlePosition);
				...
				m_handlePos = m_bottomLeftCornerPosition + (imageWarpTransform.rotation * Vector3.Scale( m_memberProperty.vector3Value, m_currentScale ));
#if UNITY_5_5_OR_NEWER
				var fmh_963_64_638849965731902446 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
#else
				m_newHandlePosition = Handles.FreeMoveHandle( m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
#endif
				Handles.DrawLine (m_bottomLeftCornerPosition, m_newHandlePosition);
			...
			if (!serializedObject.FindProperty ("m_bezierEdges").boolValue)
			{
				...
				#if UNITY_5_5_OR_NEWER
				var fmh_1007_64_638849965731905391 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle (m_handlePos, HandleUtility.GetHandleSize (m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
				#else
				m_newHandlePosition = Handles.FreeMoveHandle (m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
				#endif
				if (!m_guiChanged && GUI.changed)
				...
				#if UNITY_5_5_OR_NEWER
				var fmh_1026_64_638849965731907737 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle (m_handlePos, HandleUtility.GetHandleSize (m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
				#else
				m_newHandlePosition = Handles.FreeMoveHandle (m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
				#endif
				if (!m_guiChanged && GUI.changed)
				...
				#if UNITY_5_5_OR_NEWER
				var fmh_1045_64_638849965731910040 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle (m_handlePos, HandleUtility.GetHandleSize (m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
				#else
				m_newHandlePosition = Handles.FreeMoveHandle (m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
				#endif
				if (!m_guiChanged && GUI.changed)
				...
				#if UNITY_5_5_OR_NEWER
				var fmh_1064_64_638849965731912322 = imageWarpTransform.rotation; m_newHandlePosition = Handles.FreeMoveHandle (m_handlePos, HandleUtility.GetHandleSize (m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotHandleCap);
				#else
				m_newHandlePosition = Handles.FreeMoveHandle (m_handlePos, imageWarpTransform.rotation, HandleUtility.GetHandleSize(m_handlePos) * BEZIER_HANDLE_SCALE, Vector3.one, Handles.DotCap);
				#endif
				if (!m_guiChanged && GUI.changed)
