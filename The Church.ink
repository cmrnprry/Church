...

{
    ...
    - work == 2:
        ~temp_string = "\"I think I was fired.\" You laugh. \"I sent a nonsense email to our biggest client and they were very upset. My supervisor was so mad at me.\""
    - work == 3:
...
#delay: 1.5
"Today, I was... a little strange. I was never the best worker at my job, but today was particularly bad." You trace the wooden grooves of the wall with your finger. The words feel stuck in your throat as you recall your day. {temp_string}

#play: liquid-drop
_Plink!_

#delay: 3
The voice is silent. You squirm uncomfortably in your seat. 
...
"I see..." The voice was quiet for a moment before continuing, "Do you {temp_string}
...

{
    ...
    - else:
        ...
        You flinch at it's tone, and look at your shoes. Did you say something wrong? You mumble an appology.
        
        "I'm not scolding you." The voice softens, and some of your anxiety alleviates. "Can you really say this was a one off event?" 
...
*[Disagree with the voice]
{
    ...
    - else:
        {
            - work == 1 or work == 2:
                ~temp_string = "you choose to push people away. It's not their fault if they decide to stop when all you do is push them away."
            - work == 3:
        ...
        It makes you angry, but... {temp_string} 
